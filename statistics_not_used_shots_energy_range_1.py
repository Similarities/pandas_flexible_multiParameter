...
my_sorted_data.switch_param_and_condition('EL on target', 3.3)
...
my_sorted_data.switch_param_and_condition('HHG 24nm-34nm', 0.)
my_sorted_data.low_pass()
Negative_entries = my_sorted_data.return_df()
...
print("all shots within this selection:", len(x[["HHG 24nm-34nm"]]) )
bandpass = bandpass_selection(Negative_entries, 'GVD in fs^2', -300, 400)
bandpass.band_pass_1()
x1 = bandpass.keep_this_selection(True)
print("all shots within this selection_negative:", len(x1[["HHG 24nm-34nm"]]) )

print('xxxxxxxxxxxx')


bandpass2 = bandpass_selection(PP_out, 'GVD in fs^2', 400, 650)
bandpass2.band_pass_1()
x2 = bandpass2.keep_this_selection(True)
print("all shots within this selection:", len(x2[["HHG 24nm-34nm"]]) )
bandpass2 = bandpass_selection(Negative_entries, 'GVD in fs^2', 400,600)
bandpass2.band_pass_1()
x2 = bandpass2.keep_this_selection(True)
print("all shots within this selection_negative:", len(x2[["HHG 24nm-34nm"]]) )
...
aaa = bandpass3.keep_this_selection(True)
print("all shots within this selection:", len(xxx[["HHG 24nm-34nm"]]) )
bandpass3 = bandpass_selection(Negative_entries, 'GVD in fs^2', 700, 1200)
x3 = bandpass3.band_pass_1()
print("All shots within this selection_negative:", len(x3[["HHG 24nm-34nm"]]) )
