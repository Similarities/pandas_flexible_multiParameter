...
#highpass: >=
#lowpass <
my_sorted_data.switch_param_and_condition('EL on target', 2.45)
my_sorted_data.high_pass()
my_sorted_data.switch_param_and_condition('EL on target', 2.71)
my_sorted_data.low_pass()
my_sorted_data.switch_param_and_condition("z um", -4490)
my_sorted_data.high_pass()
my_sorted_data.switch_param_and_condition("z um", -3105)
my_sorted_data.low_pass()
