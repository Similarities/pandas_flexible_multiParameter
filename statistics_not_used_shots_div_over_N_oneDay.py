...
class discriminate_parameters:
    ...
    def black_white_discrimination_with_argument(self):
...
my_sorted_data.switch_param_and_condition('day', 20190123)
my_sorted_data.black_white_discrimination_with_argument()
my_sorted_data.switch_param_and_condition('GVD in fs^2', 900)
my_sorted_data.black_white_discrimination_with_argument()
...
my_sorted_data.switch_param_and_condition("Nmax", 20)
my_sorted_data.high_pass()
#my_sorted_data.low_pass()
...
print("all shots in this selection:", len(x[['div25 gauss']]))
print("not used shots ratio:", x[['div25 gauss']].isna().sum()/ len(x[['div25 gauss']]) )


print('xxxxxxxxxxxx')


bandpass2 = bandpass_selection(PP_out, 'GVD in fs^2', 400, 550)
xx = bandpass2.band_pass_1()

xx[['div25 gauss']] = xx[['div25 gauss']].replace(0., np.nan)
print("not evaluable :", xx[['div25 gauss']].isna().sum())
print("all shots in this selection:", len(xx[['div25 gauss']]))
print(xx)
print("not used shots ratio:", xx[['div25 gauss']].isna().sum()/ len(xx[['div25 gauss']]) )
...
bandpass3 = bandpass_selection(PP_out, 'GVD in fs^2', 600, 1000)
xxx = bandpass3.band_pass_1()
bandpass3.keep_this_selection(True)
print(xxx[['div25 gauss']].replace(0., np.nan))
