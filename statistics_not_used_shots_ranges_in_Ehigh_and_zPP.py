...
#highpass: >=
#lowpass <
my_sorted_data.switch_param_and_condition('PP in out', 11)
...
my_sorted_data.switch_param_and_condition("z um", -1000)
my_sorted_data.high_pass()
my_sorted_data.switch_param_and_condition("z um", 1100)
my_sorted_data.low_pass()
...
print(x[["day", "shot", "z um", "GVD in fs^2", "PP in out", "Nmax"]])
...
print(xx[["day", "shot", "z um", "GVD in fs^2", "PP in out", "Nmax"]])
print('xxxxxxxxxxxx')
...
print(xxx[["day", "shot", "z um", "GVD in fs^2", "PP in out", "Nmax"]])
