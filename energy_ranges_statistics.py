...
#highpass: >=
#lowpass <
my_sorted_data.switch_param_and_condition('EL on target', 2.305)
my_sorted_data.high_pass()
my_sorted_data.switch_param_and_condition('EL on target', 2.705)
...
print('xxxxxxxxxxxx 2.4-2.7J on target')
