...
stepsize_x = stepsize_x_axis( 0, 1000)
...
#print(x['IL'])
mean_x, mean_y, erry = mean_of_something_vs_something(x, stepsize_x, 0.001, "IL", "divergence N=25", "[mrad]","GDD -300 - 300 fs^2"  )
plot_together_in_one_graph("c", "GDD -200- 300 fs^2", mean_x, mean_y, "IL 1E19 [W/cm^2]", 'divergence N25 [mrad]', errx, erry)


bandpass2 = bandpass_selection(PP_out, 'GVD in fs^2', 400, 900)
xx = bandpass2.band_pass_1()
mean_x, mean_y,  erry = mean_of_something_vs_something(xx, stepsize_x, 0.001, "IL", "divergence N=25", "[mrad]","GDD 400 - 700 fs^2"  )
plot_together_in_one_graph("r", "GDD 400- 700 fs^2", mean_x, mean_y, "IL 1E19[W/cm^2]", 'divergence N25 [mrad]', errx, erry)
...
mean_x, mean_y, erry = mean_of_something_vs_something(xxx, stepsize_x, 0.001, "IL", "divergence N=25", "[mrad]","GDD 900 - 1200 fs^2"  )
plot_together_in_one_graph("black", "GDD 900 - 1200 fs^2", mean_x, mean_y, "IL 1E19[W/cm^2]", 'divergence N25 [mrad]', errx, erry)
