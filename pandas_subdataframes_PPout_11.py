...
class Sort_and_Copy_Dataframe:
    ...
    def new_column(self, liste, name):
        ...
        if len(liste) == self.len_of_dif():
            ...
            print(liste, 'format before df')
            self.copy.insert(1,name,liste,True)
        
            #self.copy[name] = liste
            
            print(self.copy[name], 'format in df')
...
plot_together_in_one_graph("c", "GDD -200- 300 fs^2", x['IL'], x['divergence N=25'], "IL 1E19 [W/cm^2]", 'divergence N25 [mrad]', errx, erry)
...
plot_together_in_one_graph("r", "GDD 400- 700 fs^2", xx['IL'], xx['divergence N=25'], "IL 1E19[W/cm^2]", 'divergence N25 [mrad]', errx, erry)
...
plot_together_in_one_graph("black", "GDD 900 - 1200 fs^2",  xxx['IL'], xxx['divergence N=25'], "IL 1E19[W/cm^2]", 'divergence N25 [mrad]', errx, erry)
